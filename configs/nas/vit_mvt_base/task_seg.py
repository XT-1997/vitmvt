...
model = dict(
    ...
    # pretrained = '/mnt/lustre/xietao/log_mvt/base_search/final_subnet_step55_20221215_2011.pth',
    backbone=dict(
...
algorithm = dict(
    ...
    model=model,
    mutator=mutator,
    mutable_cfg='/home/dk/vitmvt/configs/nas/vit_mvt_base/vit_mvt_base.yaml',
